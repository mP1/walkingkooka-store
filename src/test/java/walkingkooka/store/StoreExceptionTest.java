...
public final class StoreExceptionTest implements StandardThrowableTesting<StoreException> {
    ...
    @Override
    public StoreException createThrowable(final String message) {
        return new StoreException(message);
    }

    @Override
    public StoreException createThrowable(final String message, final Throwable cause) {
        return new StoreException(message, cause);
    }
